...
public:
  ...
  static inline isl::aff var_on_domain(isl::local_space ls, enum isl_dim_type type, unsigned int pos);
};
...
public:
  ...
  static inline isl::ast_node from_ast_node_list(isl::ast_node_list list);
  ...
  inline isl::ast_node set_annotation(const std::string &annotation) const;
  inline std::string to_C_str() const;
};
...
public:
  ...
  inline isl::stride_info range_stride_info(int pos) const;
  inline isl::stride_info get_range_stride_info(int pos) const;
  inline isl::space space() const;
  inline isl::space get_space() const;
  inline isl::id tuple_id(enum isl_dim_type type) const;
  inline isl::id get_tuple_id(enum isl_dim_type type) const;
...
public:
  ...
  inline isl::aff aff(int pos) const;
  inline isl::aff get_aff(int pos) const;
  inline isl::aff_list aff_list() const;
  ...
  static inline isl::multi_aff project_out_map(isl::space space, enum isl_dim_type type, unsigned int first, unsigned int n);
  ...
  inline isl::multi_aff set_tuple_id(enum isl_dim_type type, const std::string &id) const;
  inline unsigned size() const;
...
public:
  ...
  inline isl::id id(int pos) const;
  inline isl::id get_id(int pos) const;
  inline isl::id_list id_list() const;
...
public:
  ...
  inline isl::pw_aff pw_aff(int pos) const;
  inline isl::pw_aff get_pw_aff(int pos) const;
  inline isl::pw_aff_list pw_aff_list() const;
  ...
  inline isl::multi_pw_aff set_tuple_id(enum isl_dim_type type, const std::string &id) const;
  inline unsigned size() const;
...
public:
  ...
  inline isl::id tuple_id(enum isl_dim_type type) const;
  inline isl::id get_tuple_id(enum isl_dim_type type) const;
  inline isl::union_pw_aff union_pw_aff(int pos) const;
  inline isl::union_pw_aff get_union_pw_aff(int pos) const;
  inline isl::union_pw_aff_list union_pw_aff_list() const;
...
public:
  ...
  inline isl::id tuple_id(enum isl_dim_type type) const;
  inline isl::id get_tuple_id(enum isl_dim_type type) const;
  inline isl::val val(int pos) const;
  inline isl::val get_val(int pos) const;
  inline isl::val_list val_list() const;
...
public:
  ...
  inline unsigned schedule_depth() const;
  inline unsigned get_schedule_depth() const;
  ...
  inline isl::union_pw_multi_aff subtree_contraction() const;
  ...
  inline isl::schedule_node group(const std::string &group_id) const;
...
public:
  ...
  inline isl::union_map partial_schedule_union_map() const;
  inline isl::union_map get_partial_schedule_union_map() const;
  inline bool permutable() const;
  inline bool get_permutable() const;
  inline isl::space space() const;
  inline isl::space get_space() const;
  inline enum isl_ast_loop_type member_get_ast_loop_type(int pos) const;
  ...
  inline schedule_node_band sink() const;
...
public:
  ...
  inline isl::space add_named_tuple_id_ui(const std::string &tuple_id, unsigned int dim) const;
  ...
  inline bool has_param(const std::string &id) const;
  ...
  inline isl::space set_set_tuple_id(const std::string &id) const;
...
public:
  ...
  inline isl::aff offset() const;
  inline isl::aff get_offset() const;
  inline isl::val stride() const;
...
isl::aff aff::param_on_domain(isl::space space, isl::id id)
{
...
isl::aff aff::var_on_domain(isl::local_space ls, enum isl_dim_type type, unsigned int pos)
{
  if (ls.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ls.ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_aff_var_on_domain(ls.release(), type, pos);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}
...
std::string ast_expr_op_access::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_add::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_address_of::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_and::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_and_then::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_call::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_cond::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_div::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_eq::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_fdiv_q::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_ge::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_gt::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_le::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_lt::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_max::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_member::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_min::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_minus::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_mul::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_or::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_or_else::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_pdiv_q::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_pdiv_r::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_select::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_sub::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
std::string ast_expr_op_zdiv_r::to_str() const {
  char *Tmp = isl_ast_expr_to_str(get());
  if (!Tmp)
    return "";
  std::string S(Tmp);
...
isl::ast_node ast_node::from_ast_node_list(isl::ast_node_list list)
{
  if (list.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = list.ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_ast_node_from_ast_node_list(list.release());
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}
...
isl::ast_node ast_node::set_annotation(const std::string &annotation) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->set_annotation(isl::id(ctx(), annotation));
}
...
isl::stride_info map::range_stride_info(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::id map::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_map_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id map::get_tuple_id(enum isl_dim_type type) const
{
...
isl::aff multi_aff::aff(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::aff_list multi_aff::aff_list() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::id multi_aff::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_aff_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id multi_aff::get_tuple_id(enum isl_dim_type type) const
{
  return tuple_id(type);
}
...
isl::multi_aff multi_aff::project_out_map(isl::space space, enum isl_dim_type type, unsigned int first, unsigned int n)
{
  if (space.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = space.ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_aff_project_out_map(space.release(), type, first, n);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}
...
isl::multi_aff multi_aff::set_tuple_id(enum isl_dim_type type, isl::id id) const
{
  if (!ptr || id.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_aff_set_tuple_id(copy(), type, id.release());
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::multi_aff multi_aff::set_tuple_id(enum isl_dim_type type, const std::string &id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->set_tuple_id(type, isl::id(ctx(), id));
...
isl::id multi_id::id(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::id_list multi_id::id_list() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::pw_aff multi_pw_aff::pw_aff(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::pw_aff_list multi_pw_aff::pw_aff_list() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::id multi_pw_aff::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_pw_aff_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id multi_pw_aff::get_tuple_id(enum isl_dim_type type) const
{
  return tuple_id(type);
}
...
isl::multi_pw_aff multi_pw_aff::set_tuple_id(enum isl_dim_type type, isl::id id) const
{
  if (!ptr || id.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_pw_aff_set_tuple_id(copy(), type, id.release());
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::multi_pw_aff multi_pw_aff::set_tuple_id(enum isl_dim_type type, const std::string &id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->set_tuple_id(type, isl::id(ctx(), id));
...
isl::id multi_union_pw_aff::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_union_pw_aff_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id multi_union_pw_aff::get_tuple_id(enum isl_dim_type type) const
{
  return tuple_id(type);
}

isl::union_pw_aff multi_union_pw_aff::union_pw_aff(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
{
  return union_pw_aff(pos);
}

isl::union_pw_aff_list multi_union_pw_aff::union_pw_aff_list() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::multi_union_pw_aff multi_union_pw_aff::set_tuple_id(enum isl_dim_type type, isl::id id) const
{
  if (!ptr || id.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_union_pw_aff_set_tuple_id(copy(), type, id.release());
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::multi_union_pw_aff multi_union_pw_aff::set_tuple_id(enum isl_dim_type type, const std::string &id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->set_tuple_id(type, isl::id(ctx(), id));
...
isl::id multi_val::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_val_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id multi_val::get_tuple_id(enum isl_dim_type type) const
{
  return tuple_id(type);
}

isl::val multi_val::val(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::val_list multi_val::val_list() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::multi_val multi_val::set_tuple_id(enum isl_dim_type type, isl::id id) const
{
  if (!ptr || id.is_null())
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_multi_val_set_tuple_id(copy(), type, id.release());
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::multi_val multi_val::set_tuple_id(enum isl_dim_type type, const std::string &id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->set_tuple_id(type, isl::id(ctx(), id));
...
isl::pw_aff pw_multi_aff::pw_aff(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::id pw_multi_aff::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_pw_multi_aff_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id pw_multi_aff::get_tuple_id(enum isl_dim_type type) const
{
  return tuple_id(type);
}
...
unsigned schedule_node::schedule_depth() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
unsigned schedule_node::get_schedule_depth() const
{
...
isl::union_pw_multi_aff schedule_node::subtree_contraction() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::schedule_node schedule_node::group(const std::string &group_id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->group(isl::id(ctx(), group_id));
}
...
isl::union_map schedule_node_band::partial_schedule_union_map() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
{
  return partial_schedule_union_map();
}
...
isl::space schedule_node_band::space() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
enum isl_ast_loop_type schedule_node_band::member_get_ast_loop_type(int pos) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_schedule_node_band_member_get_ast_loop_type(get(), pos);
  return res;
}
...
schedule_node_band schedule_node_band::sink() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::space space::add_named_tuple_id_ui(const std::string &tuple_id, unsigned int dim) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->add_named_tuple_id_ui(isl::id(ctx(), tuple_id), dim);
}
...
unsigned space::dim(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_space_dim(get(), type);
  if (res < 0)
    exception::throw_last_error(saved_ctx);
  return res;
}
...
isl::id space::tuple_id(enum isl_dim_type type) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  auto res = isl_space_get_tuple_id(get(), type);
  if (!res)
    exception::throw_last_error(saved_ctx);
  return manage(res);
}

isl::id space::get_tuple_id(enum isl_dim_type type) const
{
  return tuple_id(type);
}
...
bool space::has_param(const std::string &id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->has_param(isl::id(ctx(), id));
}
...
isl::space space::set_set_tuple_id(const std::string &id) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->set_set_tuple_id(isl::id(ctx(), id));
}
...
stride_info manage_copy(__isl_keep isl_stride_info *ptr) {
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = isl_stride_info_get_ctx(ptr);
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
    ...
    : ptr(nullptr)
{
  if (!obj.ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = isl_stride_info_get_ctx(obj.ptr);
  options_scoped_set_on_error saved_on_error(saved_ctx, exception::on_error);
  ptr = obj.copy();
  if (!ptr)
    exception::throw_last_error(saved_ctx);
...
isl::ctx stride_info::ctx() const {
  return isl::ctx(isl_stride_info_get_ctx(ptr));
}

isl::aff stride_info::offset() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::val stride_info::stride() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
unsigned union_map::n_map() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::pw_aff_list union_pw_aff::pw_aff_list() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
...
isl::union_pw_multi_aff union_pw_multi_aff::scale(int64_t val) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->scale(isl::val(ctx(), val));
}
...
isl::union_pw_multi_aff union_pw_multi_aff::scale_down(int64_t val) const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  return this->scale_down(isl::val(ctx(), val));
}
...
unsigned union_set::n_set() const
{
  if (!ptr)
    exception::throw_invalid("NULL input", __FILE__, __LINE__);
  auto saved_ctx = ctx();
